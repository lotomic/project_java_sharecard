...
<html lang="en">
    ...
    <body>
        <div class="zaglavlje">
           <a href="../index.php" class="naslovi"><img class="slika3" src="../resources/slike/ic_launcher.png" alt="back" width="40" height="40" >ShareCard registration</a>
        </div>
        <div class="registracija">
            <form  id="registracijska_forma" enctype="multipart/form-data" method="post" name="registracijska_forma" action="obradaRegistracije.php">
                <label>Name</label><br>

                 <input type="text" id="name"  class="naziv" placeholder="Name"/>
                 <input type="text" id="lname"  class="naziv" placeholder="Lastname"/><br>
                 <label>Date of birth</label><br>
               <select id="rodenje" name="dan"  class="rodenje">
                   ...
                   <select id="mjesec" class="rodenje" ><option selected="" value="">Month</option>
                ...
                <select id="godina" name="godina" class="rodenje" ><option selected="" value="">Year</option>
                ...
                <select class="rodenje2">
                    <option>Gender</option>
                    <option>Male</option><option>Female</option><option>Other</option>
                </select>
                 <br><label>Email*</label><br>
                <?php
                       if(isset($_SESSION["error"]["email_reg"])){
                           echo $_SESSION["error"]["email_reg"];
                       } 
                    ?>
                 <br>
                <input type="email" class="naziv2" required="required" id="email_reg" name="email_reg" placeholder="example@gmail.com"/><br>
                
                <label>Password* </label><br>
                <input type="password" required="required" id="pass" name="pass" class="naziv2" placeholder="Password"><br>
         
                <label>Retype password*</label><br>
                  <?php
                       if(isset($_SESSION["error"]["repass"])){
                           echo $_SESSION["error"]["repass"];
                       } 
                    ?><br>
                <input type="password" required="required" id="repass" name ="repass" class="naziv2" placeholder="Password"><br>
                <input type="submit" id="submitt" name="submitt" class="gumb" value="Sing Up">
               
               
            </form>
        </div>
           <div class="pocetna_slika2" id="slika">
            <img id="slikica" src="../resources/slike/pocetna_slika_3.png" alt="apstract art :)"/>
        </div>
